(function ($, window, document, undefined) {
    ...
    function init(target, options) {
        ...
        //初始化各个组件
        var $msb_main = $msb_main = "<a class='msb_main'><img title='分享' src='fore/img/share_core_square.jpg'></a>";
...
function loadShareInfo(target) {
    ...
    var result = {
        ...
        summary: $(parent).data("desc") != null ? $(parent).data("desc") : '54lxb个人博客分享,欢迎指教',
